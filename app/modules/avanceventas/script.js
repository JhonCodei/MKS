...
{
    var controller = __AJAX__ + "avanceventas-listar_avance",
        connect, postData;
...
function detail_clientes(vendedor, periodo, region)
{
    $("#loader").empty();

    var controller = __AJAX__ + "avanceventas-detail_clientes",
        connect, form, explode;

    form = "periodo=" + periodo + "&vendedor=" + vendedor + "&region=" + region;
...
function detail_total_ventas(vendedor, periodo, region)
{

    $("#loader").empty();

    var controller = __AJAX__ + "avanceventas-detail_total_ventas",
        connect, form, explode;
...
function detail_productos(vendedor, region, cliente_cod, dist_cod, periodo)
{
    $("#loader").empty();

    var controller = __AJAX__ + "avanceventas-detail_productos",
        connect, form, explode;
...
function reporte()
{
    ...
    var controller = __AJAX__ + "avanceventas-reporte",
        connect, form, explode;
