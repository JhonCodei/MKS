      <div class="row">
        ...
        <span class="fa fa-arrow-circle-left"></span></a> &nbsp;<b class="h2 text-dark" >Nuevo Pedido</b>
          ...
          <div class="col-md-12">
            <textarea name="" id="notas" class="form-control text-center" placeholder="observaciones" cols="100" rows="10"></textarea>
          </div>
            <div class="col-lg-12">
            <br>
              ...
              <table id="table-pedidos-add" class="table table-striped table-condensed table-bordered table-sm"> 
                ...
                <tbody id="parent-div_insertar">
                      ...
                      <div class="row">
                        <div class="col-md-4">
                            <div class="input-group">
                                ...
                                <input type="number"  onblur="precio_lista_x_prod_x_dist(1);_buscar_producto(1);" onchange="precio_lista_x_prod_x_dist(1);" class="form-control input-sm text-center border border-secondary font_inside_input" placeholder="Cod." name="prod_cod_insertar[]" id="prod_cod_1">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div>
                                <span class="input-group-addon input-sm bg-inverse text-white border border-dark inp-g-ad_alter">Producto</span>
                                <input type="text" readonly="true" class="form-control input-sm text-center border border-secondary font_inside_input" id="prod_desc_1" name="prod_desc_insertar[]">
                            </div>
                        </div>
                        <div class="col-md-4" >
                            <div class="input-group">
                        ...
                        <div class="col-md-3">
                          <form class="form-inline">
                            <div class="input-group">
                                ...
                                <input type="text" style="font-size:0.7em !important;" readonly="true" class="form-control input-sm text-center border border-secondary font_inside_input" id="prec_list_1" name="prec_list_insertar[]">
                            </div>
                          </form>
                        </div>
                        <div class="col-md-3">
                          <form class="form-inline">
                            <div class="input-group">
                                ...
                                <input type="text" style="font-size:0.7em !important;" readonly="true" class="form-control input-sm text-center border border-secondary font_inside_input" id="porc_desc_1" name="porc_desc_insertar[]">
                            </div>
                          </form>
                        </div>
                        <div class="col-md-3">
                          <form class="form-inline">
                            <div class="input-group">
                                ...
                                <input type="text" style="font-size:0.7em !important;" readonly="true" class="form-control input-sm text-center border border-secondary font_inside_input" id="prec_unidad_1" name="prec_unidad_insertar[]">
                            </div>
                          </form>
                        </div>
                        <div class="col-md-3">
                          <form class="form-inline">
                            <div class="input-group">
                                ...
                                <input type="text" style="font-size:0.7em !important;" readonly="true" class="form-control input-sm text-center border border-secondary font_inside_input" id="prec_uni_igv_1" name="prec_uni_igv_insertar[]">
                            </div>
                          </form>
                        </div>
                      </div>
                        ...
                        <div class="col-md-4">
                          <form class="form-inline">
                            <div class="input-group">
                                ...
                                <input type="text" readonly="true" style="font-size:0.7em !important;" class="form-control input-sm text-center border border-secondary font_inside_input" id="monto_desc_1" name="monto_desc_insertar[]">
                            </div>
                          </form>
                        </div>
                        <div class="col-md-4">
                          <form class="form-inline">
                            <div class="input-group">
                                ...
                                <input type="text" readonly="true" style="font-size:0.7em !important;" class="form-control input-sm text-center border border-secondary font_inside_input" id="valor_neto_1" name="valor_neto_insertar[]">
                            </div>
                          </form>
                        </div>
                        <div class="col-md-4">
                            <div>
                                ...
                                <input type="text" readonly="true" style="font-size:0.7em !important;" class="form-control input-sm text-center border border-secondary font_inside_input" id="monto_line_total_1" name="monto_line_total_insertar[]" />
                            </div>
                        </div>
                  ...
                  <tr id="2tr1">
                    <td></td>
                    <td colspan="3">
                        <input type="text" class="form-control" placeholder="observaciones" onkeypress="return max_length(this.value, 130);" name="obs_line_1" id="obs_line_insertar[]">
                    </td>
                  </tr>                
                </tbody>
              </table>
